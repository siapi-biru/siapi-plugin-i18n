...
module.exports = () => {
  ...
  _.set(siapi.plugins.i18n.config, 'schema.graphql', {});

  Object.values(siapi.contentTypes).forEach(contentType => {
  ...
  siapi.db.migrations.register(fieldMigration);
  siapi.db.migrations.register(enableContentTypeMigration);
  siapi.db.migrations.register(disableContentTypeMigration);
};
