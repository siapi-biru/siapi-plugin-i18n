...
import { request, useUserPermissions } from 'siapi-helper-plugin';
import { fireEvent, render, screen, within, waitFor } from '@testing-library/react';
import { ThemeProvider } from 'styled-components';
import { QueryClient, QueryClientProvider } from 'react-query';
import LocaleSettingsPage from '..';
import themes from '../../../../../../siapi-admin/admin/src/themes';
...
describe('i18n settings page', () => {
  beforeEach(() => {
    ...
    siapi.notification.toggle = jest.fn();
  });
  ...
  describe('delete', () => {
    it('removes the locale when clicking the confirmation button', async () => {
      ...
      await waitFor(() =>
        expect(siapi.notification.toggle).toBeCalledWith({
          type: 'success',
